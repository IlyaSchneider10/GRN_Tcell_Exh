...
for (x in seq(nrow(frequency_summary))){
  ...
  adj_frequency_files_importance_scores[[x]]<-imp
}
...
#Calculate average importance score for each interaction along scenic runs
...
frequency_summary_top100<-frequency_summary_top100[,c(1,2)]
...
```{r}
cluster_louvain(as.undirected(g.subset))
```
