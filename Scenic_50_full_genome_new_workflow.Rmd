...
#wrong
aucell_scores_norm_cell_types_binarized<-aucell_scores_norm_cell_types_means
for (x in colnames(aucell_scores_norm_cell_types_means)){
  for (y in rownames(aucell_scores_norm_cell_types_means)){
    if (y<cutoff_thresholds[x]){
      aucell_scores_norm_cell_types_binarized[y,x]<-0
    }else{aucell_scores_norm_cell_types_binarized[y,x]<-1}
  }
}
